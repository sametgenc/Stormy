...
export class MessagesPage implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.subscribeMessages();
     ...
     // Toplam mesaj sayınısı ileride lazım olabilir
  ...
  subscribeMessages(): void {
    ...
    // Yeni dataset alındığında kaydırma pozisyonunu yeniden ayarlamak için kullanılacak özel ofset
    ...
    MeteorObservable.subscribe('messages',
      ...
      // Adımlara göre view ı değiştiriyoruz
      if (!this.messagesComputation) {
        this.messagesComputation = this.autorunMessages();
      }
 
      // Gelen subscription requestslerine izin ver
